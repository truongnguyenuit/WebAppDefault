  ...
  return (
    <div className="bg-white">
      <Row className='border border-slate-200'>
        ...
        <Col span={2} className="flex justify-center items-center bg-slate-600">
          <div className='bg-slate-200 w-[20px] h-[20px] '>
        ...
        <Col span={2}>
        <div className='flex justify-center items-center text-[14px] font-semibold gap-4 h-14'>
          <Link to={''}>
            <p>Tất cả</p>
          </Link>
