...
const TopBarComponent = () => {
  ...
  return (
    ...
    <div className="bg-[#ecf0f1] border-b border-slate-300 p-[20px]">
      <Row>

        <Col span={8}>
          <div className="flex justify-start items-center text-[20px] gap-2 h-20">
        ...
        <Col span={8}>
          <div className="flex justify-end items-center text-[16px] gap-2 h-20">
