...
const PostComponent = ({ realName, userName, email, img, oldPassword, page }) => {
  const {
    deleteBlog,
    updateBlog
  ...
  return (
    <div className="w-[329px] mx-1 my-1 flex flex-col bg-white drop-shadow-md rounded-[8px] overflow-hidden">
      ...
      <div className='flex justify-between mt-[12px] ml-[12px] mr-[15px] '>
        <p className='bg-red-400 p-[4px] drop-shadow-md rounded-[8px] overflow-hidden font-bold text'>category: </p>
        {modify}
      </div>

      <div className='mx-[12px] mb-[12px]'>
        <h1 className="text-[17px] font-bold cursor-pointer">asdasd</h1>
        <div className="flex flex-row gap-[7px]">
          <img className="w-[180px] h-[130px] object-cover" src={''} alt="" />
          <p className="leading-6 font-normal">as,...</p>
        </div>
      </div>
