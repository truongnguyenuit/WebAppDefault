...
const PostComponent = ({ createAt, realName, userName, email, img, password, _id, page }) => {
  const {
    deleteBlog,
    updateBlog
  ...
  return (
    <div className="w-[329px] mx-1 my-1 flex flex-col bg-white drop-shadow-md rounded-[8px] overflow-hidden">
      ...
      <div className='mx-[12px] mb-[12px]'>
        <span className=""><span className='font-bold'>_id: </span> {_id}</span>
        <span className=""><span className='font-bold'>realName:</span> {realName}</span>
        <span className=""><span className='font-bold'>userName:</span> {userName}</span>
        <span className=""><span className='font-bold'>password:</span> {password}</span>
        <span className=""><span className='font-bold'>createAt:</span> {createAt}</span>
