...
const PostComponent = ({ title, description, img, user, time, _id, page }) => {
  const {
    deleteBlog,
    updateBlog
  ...
  return (
    <div className="w-[340px] mx-1 my-1 flex flex-col bg-white drop-shadow-md rounded-[8px] overflow-hidden">
