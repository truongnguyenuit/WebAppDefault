      ...
      <Row className='border border-slate-200'>
        ...
        <Col span={2}>
          <div className='flex justify-end items-center text-[14px] font-semibold gap-4 h-14'>
            <div className='bg-slate-300 w-[20px] h-[20px] flex justify-center items-center rounded-full'>
        ...
        <Col span={2}>
          <div className='flex justify-start items-center text-[14px] font-semibold gap-2 h-14'>
            <Link to={''}>
              <p className='m-0 text-state-200'>Tất cả</p>
            </Link>
