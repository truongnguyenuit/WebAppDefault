  ...
  return (
    ...
    <div className="bg-[#ecf0f1]">
      <Row>
        ...
        <Col span={8}>
          <div className="flex justify-center items-center text-[20px] gap-2 h-20">
        ...
        <Col span={8}>
          <div className="flex justify-center items-center text-[20px] h-20">
            <Search className="p-[10px]" placeholder="input search text" onSearch={''} enterButton />
          </div>
        </Col>

        <Col span={8}>
          <div className="flex justify-center items-center text-[17px] gap-2 h-20">
