...
const AboutComponent = () => {
  return (
    <div className="flex flex-col items-center bg-white drop-shadow-md w-[350px] py-8 rounded-[6px] overflow-hidden">
      ...
      <div className="w-[298px] mb-[20px] mt-[20px]">
        <p className="font-serif">
          Để thuê quảng cáo, vui lòng liên hệ Truong Nguyen, 0586455838
        </p>
      </div>
