          ...
          <div className='flex flex-col gap-[10px] text-[14px]'>
            ...
            <div>
              <div className='flex gap-[50px]'>
                <span><i class="fa-solid fa-envelope text-gray-400 mr-[4px]"></i>Tòa soạn</span>
                <span><i class="fa-solid fa-rectangle-ad text-green-700  mr-[4px]"></i>Quảng cáo</span>
              </div>
              <span> <i class="fa-solid fa-address-card text-yellow-600 mr-[4px]"></i>Hợp tác bản quyền</span>
            </div>
            <span>Đường dây nóng</span>
            <span className='font-bold text-[17px]'>083.888.0123--------082.233.3555</span>
