...
const HomePage = () => {
  ...
  return (
    <div className='bg-slate-100'>
      ...
      <Row className='p-[13px] flex justify-center bg-white drop-shadow-md rounded-[8px] overflow-hidden'>
        <Col span={3}>
        ...
        <Col span={21} >
          <div className='flex flex-row justify-between'>
            ...
            <div className='flex gap-[12px] items-center'>
              ...
              <span className='text-gray-400'>Theo dõi VnExpress trên</span>
              <div className="flex justify-center items-center text-[20px] gap-2 h-14">
                <i className="fa-brands fa-facebook-square cursor-pointer text-blue-600"></i>
                <i className="fa-brands fa-twitter-square cursor-pointer text-blue-500"></i>
                <i className="fa-brands fa-instagram-square cursor-pointer text-red-500"></i>
                <i className="fa-brands fa-pinterest-square cursor-pointer text-red-700"></i>
              </div>
            </div>
          </div>
        </Col>
      </Row>
      <Row className='p-[13px] flex justify-center bg-white'>
        <Col span={6} >
          <div className='flex flex-col'>
            <span className='font-bold'>Báo tiếng Việt nhiều người xem nhất</span>
            <span>Thuộc Bộ Khoa học và Công nghệ</span>
        ...
        <Col span={6}>
          <div className='flex flex-col'>
            <span>Bản quyền thuộc về TruongExpress</span>
