  ...
  return (
    <div className='bg-slate-100'>
      ...
      <Row className='pt-[5px]  flex justify-center'>
        ...
        <Col span={16}>
          <div className="flex ">
            <span className='text-[18px]'>Kinh doanh</span>
            <span className='text-[18px]'>Quốc tế</span>
            <span className='text-[18px]'>Doanh nghiệp</span>
            <span className='text-[18px]'>Chứng khoán</span>
            <span className='text-[18px]'>Bất động sản</span>
            <span className='text-[18px]'>Bảo hiểm</span>
          </div>
        </Col>
      </Row>
